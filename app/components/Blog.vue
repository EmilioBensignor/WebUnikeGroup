<template>
    <DefaultSection id="blog" class="md:bg-gray-light md:pt-0 md:pb-8 lg:pb-12 md:px-8 lg:px-16">
        <div
            class="xxl:max-w-[1304px] xxl:w-full md:flex md:flex-col md:gap-6 xxl:gap-8 relative md:rounded-[48px] pb-6 md:py-8 md:px-12 lg:px-16 overflow-hidden">
            ...
            <div
                ...
                <NuxtLink :to="ROUTES_NAMES.UNIKE.BLOG">
                    <ButtonPrimary
                        class="sm:self-start relative z-10 !bg-white md:!bg-primary !text-primary md:!text-white !px-12">
                        Ir al
                        blog
                    </ButtonPrimary>
                </NuxtLink>
            ...
            <CarouselStatic v-else :slides-per-view="{ base: 1.4, sm: 2.5, md: 3, lg: 3, xl: 4, xxl: 4 }"
                :button-position="{
                    top: '50%',
