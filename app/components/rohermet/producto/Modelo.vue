...
const { processProductoHTML } = useRohermetProductos()
...
const get3DViewerUrl = () => {
    ...
    if (producto.value.archivo_html) {
        ...
        return `${config.public.supabase.url}/storage/v1/object/public/rohermet-productos/${producto.value.archivo_html}`
    }
...
const getImageUrl = (imagen) => {
    ...
    return `${config.public.supabase.url}/storage/v1/object/public/rohermet-productos/${imagen}`
}
