<template>
    <div class="flex flex-col items-center gap-2">
        ...
        <div class="w-full flex flex-col justify-center items-center gap-4 lg:gap-8 px-5 lg:px-2 pb-4">
            <HeadingH3 class="text-center lg:!text-2xl text-primary font-bold">
                {{ producto.capacidad_lts ? `${producto.nombre} - ${producto.capacidad_lts}L` : producto.nombre }}
            </HeadingH3>
            <div v-if="hasCaracteristicas" class="flex flex-wrap justify-center items-end gap-4 lg:gap-6">
                <div v-if="producto.caracteristica1 && producto.icono1" class="flex flex-col xxl:flex-row items-center gap-2">
                    <div class="w-12 h-12 flex justify-center items-center rounded-full bg-secondary">
            ...
            <NuxtLink :to="`/rohermet/${producto.categoria?.slug || 'categoria'}/${producto.slug}`">
