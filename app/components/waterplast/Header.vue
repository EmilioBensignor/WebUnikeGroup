<template>
    <header :class="[
        ...
        <nav class="hidden lg:flex">
            <ul class="flex items-center text-white font-bold">
                ...
                <li v-for="(item, index) in conditionalMenu" :key="index" v-show="!item.isCatalogo || catalogoUrl"
    ...
    <WaterplastDrawer :isOpen="isDrawerOpen" :catalogoUrl="catalogoUrl" @close="closeDrawer" />
</template>
...
onMounted(async () => {
    ...
    fetchCatalogoByMarca('Waterplast').then((url) => {
